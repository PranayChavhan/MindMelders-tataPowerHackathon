...
function Windmill_Mini:init()

    --self.image = love.graphics.newImage('sprites/Windmill_Minis.jpg')
    player = {
        grid_x = 1,
        grid_y = 1,
     }
...
function Windmill_Mini:update(dt)
...
function Windmill_Mini:render()

    print(tostring(player.grid_x.." "..player.grid_y),width+100,0)
    -- the maze
